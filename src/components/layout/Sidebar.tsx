  ...
  return (
    <div className="flex flex-col w-64 bg-green-900 text-green-50 min-h-screen border-r border-green-800">
      <div className="flex items-center justify-center h-16 border-b border-green-800">
        <h1 className="text-xl font-bold text-white tracking-wider">SMART BILLING</h1>
      </div>
      ...
      <div className="p-4 border-t border-green-800 text-xs text-green-200/70 text-center">
