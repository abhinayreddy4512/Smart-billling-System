...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Successful registration directly logs in and goes to onboarding
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
        <div className="bg-emerald-950 p-8 text-center">
          <div className="bg-emerald-800 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-inner">
            <UserPlus className="w-8 h-8 text-emerald-100" />
          </div>
          <h1 className="text-2xl font-bold text-white">Create Account</h1>
          <p className="text-emerald-200 mt-2 text-sm">Join the Smart Billing System</p>
        </div>
